...
function Movie() {
    ...
    useEffect(() => {
        const fetchDeatils = async () => {
            const response = await fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=c5b5985fb1a8f07ebcd36de9e82c4de6&&language=en-US&append_to_response=videos,images,credits`);
            ...
            <div className='w-full text-white flex flex-col justify-center items-center'>
                ...
                <div className='absolute top-[10%] p-4 '>
                    <div className='relative mt-40 flex flex-col justify-center items-center'>
                        ...
                        <div className='mt-5'>
                            <h1 className='text-3xl md:text-5xl font-bold'>{detailData.original_title}</h1>
                        </div>
